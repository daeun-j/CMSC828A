...
def LEEP(pseudo_source_label: np.ndarray, target_label: np.ndarray):
    ...
    for i in range(C_t):
        ...
        joint[i] = row
    p_target_given_source = (joint / (joint.sum(axis=0, keepdims=True)+ 1e-8)).T  # P(y | z)
    ...
    leep_score = np.mean(np.log(empirical_prob, where=(empirical_prob>0)))
    return leep_score

    #predictions
    # {'score': 16.833893299102783, 'start_logit': 7.16024923324585, 
    #  'end_logit': 9.673644065856934, 'text': 'a reduction'}

def get_start_end_position():
    global temp_predictions
    global start_index_list, end_index_list

    return temp_predictions, start_index_list, end_index_list
...
def postprocess_qa_predictions( 
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        for feature_index in feature_indices:
            ...
            # print("here start_index ", start_index)
            # print("here end_index ", end_index)
        global start_index_list, end_index_list
        ...
        # print("######## predictions in utils_qa dataset: ########", type(predictions))
        # print(predictions)
        ...
        # print("######## best_non_null_pred in utils_qa dataset: ########", type(best_non_null_pred))
        # print(best_non_null_pred)
    ...
    # print("######## All prediction in utils_qa dataset: ########", type(all_predictions))
    # print(all_predictions)

    output_dir= "/Users/yoonie/Desktop/828a_project1/output/"
