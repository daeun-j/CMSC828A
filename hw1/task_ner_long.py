...
task_sampler = TaskSampler(dataloader_dict=dataloader_dict, max_iters=max_iters, task_weights=[0, 1])
...
epoch_loss = []
task_sampler.set_sample_task([0, 1])
